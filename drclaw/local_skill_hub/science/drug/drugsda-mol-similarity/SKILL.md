...
description: Compute the Tanimoto similarities between a target molecule and a list
  of candidate molecules using Morgan fingerprints.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 计算分子Tanimoto相似度。
---
