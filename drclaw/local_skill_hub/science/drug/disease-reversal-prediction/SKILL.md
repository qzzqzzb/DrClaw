...
description: Predict a molecule's ability to reverse disease states using DLEPS (Disease-Ligand
  Embedding Projection Score) for drug repositioning and discovery.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 预测分子逆转疾病能力。
---
