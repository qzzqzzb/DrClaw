...
description: Given a gene symbol (e.g. TPMT), query 3 public databases (ClinGen CAR,
  PharmGKB, Monarch) to obtain gene registry info, FDA drug labels, clinical annotations,
  and gene-phenotype associations. Save all results into a JSON file.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 查询基因信息并保存为JSON。
---
