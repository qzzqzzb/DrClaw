...
description: Query PharmGKB (clinPGx) for pharmacogenomic clinical annotations — how
  a variant affects drug response, dosing, and adverse reactions.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 查询变异对药物反应的影响。
---
