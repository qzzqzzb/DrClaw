...
description: Comprehensive drug screening pipeline from molecular filtering through
  QED/ADMET criteria to protein-ligand docking, identifying promising drug candidates.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 药物筛选与分子对接。
---
