...
description: Compute the drug-likeness metrics (QED score and Number of violations
  of Lipinski's Rule of Five) of the input candidate molecules (SMILES format).
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 计算药物相似性指标。
---
