...
description: 'Bioassay Data Analysis - Analyze bioassay data: PubChem assay summary,
  ChEMBL activity search, compound properties, and target info. Use this skill for
  bioassay science tasks involving get assay summary by cid search activity calculate
  mol basic info get target by name. Combines 4 tools from 3 SCP server(s).'
i18n:
  zh:
    description: 生物测定数据分析。
---
