...
description: Analyze chemical structures from compound names to retrieve SMILES, molecular
  formulas, molecular weight, and LogP values.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 分析化合物结构，获取SMILE。
---
