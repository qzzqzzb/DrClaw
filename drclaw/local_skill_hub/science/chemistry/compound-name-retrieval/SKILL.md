...
description: Retrieve SMILES strings from PubChem database using compound names to
  obtain molecular structures from common chemical names.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 用化合物名从PubChem获取。
---
