...
description: Query NCBI ClinVar for variant clinical pathogenicity classification
  (Pathogenic/Benign/VUS), review status and associated diseases.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 查询变异临床致病性分类。
---
