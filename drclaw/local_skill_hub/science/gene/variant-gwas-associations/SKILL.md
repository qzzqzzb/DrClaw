...
description: Query EBI GWAS Catalog for GWAS statistical associations (p-value, effect
  size, risk allele) between a variant and traits/diseases.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 查询变异与性状的GWAS关联。
---
