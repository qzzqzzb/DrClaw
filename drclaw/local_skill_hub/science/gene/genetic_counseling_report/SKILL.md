...
description: 'Genetic Counseling Variant Report - Generate variant report for genetic
  counseling: VEP, ClinVar, gene phenotype, and literature evidence. Use this skill
  for clinical genetics tasks involving get vep hgvs clinvar search get phenotype
  gene pubmed search. Combines 4 tools from 2 SCP server(s).'
i18n:
  zh:
    description: 生成遗传咨询变异报告。
---
