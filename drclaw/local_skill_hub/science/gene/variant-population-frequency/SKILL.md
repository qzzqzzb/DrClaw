...
description: 'Query gnomAD for variant allele frequency across populations. Uses FAVOR
  to convert rsID→variant_id first, then queries gnomAD. '
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 查询gnomAD变异等位基因频。
---
