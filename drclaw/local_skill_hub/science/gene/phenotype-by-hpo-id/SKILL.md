...
description: Retrieve phenotype information from Monarch Initiative using HPO (Human
  Phenotype Ontology) IDs to understand disease manifestations.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 用HPO ID获取表型信息。
---
