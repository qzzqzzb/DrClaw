...
description: 'Multi-Omics Integration - Integrate multi-omics: gene expression, protein
  data, pathway enrichment, and metabolic pathways. Use this skill for multi-omics
  tasks involving get gene expression across cancers get uniprotkb entry by accession
  get functional enrichment kegg get. Combines 4 tools from 4 SCP server(s).'
i18n:
  zh:
    description: 多组学整合：基因、蛋白、通路。
---
