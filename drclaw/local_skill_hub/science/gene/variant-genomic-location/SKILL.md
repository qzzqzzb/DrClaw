...
description: Query dbSNP + NCBI Gene to get variant genomic position (chromosome,
  coordinates, ref/alt alleles, mutation type) and associated gene coordinates.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 查询变异基因组位置及基因坐标。
---
