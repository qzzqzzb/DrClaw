...
description: Retrieve gene information from NCBI Gene database by gene IDs to obtain
  genomic details, function, and expression data.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 从NCBI获取基因详情。
---
