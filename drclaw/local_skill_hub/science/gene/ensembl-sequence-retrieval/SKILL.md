...
description: Retrieve genomic sequences from Ensembl database using transcript or
  gene IDs to obtain nucleotide and protein sequences.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 从Ensembl获取基因或转录。
---
