...
description: Query IGVF Catalog for regulatory element–gene associations within a
  genomic region, including association scores, element types, and biosample context.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 查询区域内调控元件-基因关联。
---
