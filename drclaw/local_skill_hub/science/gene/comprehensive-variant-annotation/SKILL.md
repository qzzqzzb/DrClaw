...
description: Given an rsID, query multiple databases (dbSNP, FAVOR, GWAS Catalog,
  ClinVar, gnomAD, PharmGKB, ClinGen) for comprehensive annotation. Use when user
  asks a general question about a variant without specifying which aspect.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 多数据库综合注释变异。
---
