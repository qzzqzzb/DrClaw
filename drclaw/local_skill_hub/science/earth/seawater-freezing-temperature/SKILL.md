...
description: Calculate the freezing point temperature of seawater from absolute salinity
  and pressure using GSW thermodynamic equations.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 计算海水冰点温度。
---
