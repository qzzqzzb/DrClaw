...
description: Calculate seawater thermodynamic properties using TEOS-10 standard including
  density, salinity, sound speed, and freezing temperature for oceanography.
license: MIT license
metadata:
  skill-author: PJLab
i18n:
  zh:
    description: 计算海水热力学性质。
---
